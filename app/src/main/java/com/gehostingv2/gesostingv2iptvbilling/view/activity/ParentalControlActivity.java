...
public class ParentalControlActivity extends AppCompatActivity implements ClientDetailInterface,
...
// finally change the color
    ...
    private Fragment getHomeFragment() {
        ParentalControlFragment servicesFragment = new ParentalControlFragment();
...
//        billingList.add("MY CREDITS");
    ...
    public void onBackPressed() {
        if (drawerLayout.isDrawerOpen(GravityCompat.START)) {
            ...
            super.onBackPressed();
            Intent settingIntent = new Intent(this, SettingssActivity.class);
