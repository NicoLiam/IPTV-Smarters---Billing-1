...
public class VoDListViewSubCatActivity extends AppCompatActivity implements VodInterface,
...
//    ProgressBar pbPagingLoader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
//        mAdapter = new VodSubCatAdpaterNew();

//        setContentView(R.layout.activity_vod_sub_cat);
...
// finally change the color
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (vodAdapter != null)
                vodAdapter.setVisibiltygone(pbPagingLoader1);
            super.onBackPressed();
            //moveTaskToBack(true);
        }
    }
