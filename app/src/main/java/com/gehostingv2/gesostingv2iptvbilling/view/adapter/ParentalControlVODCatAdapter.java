...
//    private ParentalControlActivitity dashboardActivity;
    private ParentalControlVODCatAdapter.ViewHolder vh;
    ...
    public ParentalControlVODCatAdapter(ArrayList<LiveStreamCategoryIdDBModel> arrayList1,
                                        Context context,
...
//        this.dashboardActivity = dashboardActivity;
    ...
    @Override
    public ParentalControlVODCatAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_live_category_list_item, parent, false);
        // set the view's size, margins, paddings and layout parameters
        vh = new ParentalControlVODCatAdapter.ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(final ParentalControlVODCatAdapter.ViewHolder holder, final int position) {
        if (arrayList != null) {
...
//                            liveStreamDBHandler.getAllPasswordStatus();
    ...
    private void setLockStatus(ParentalControlVODCatAdapter.ViewHolder holder, String categoryId) {
        liveStreamDBHandler.getAllPasswordStatus();
        passwordStatusDBModel =
                liveStreamDBHandler.getPasswordStatus(username, categoryId);
